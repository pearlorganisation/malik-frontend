...
import { User, Mail, Phone, Clock, ShieldCheck, Plus, Minus } from 'lucide-react';

// FAQ Data
const FAQS = [
  {
    question: "What is included in the Desert Safari?",
    answer: "Our standard package is all-inclusive: centralized pick-up, 45 mins of dune bashing, camel riding, sandboarding, unlimited refreshments, and a full BBQ dinner with live shows."
  },
  {
    question: "Is the dune bashing safe for children?",
    answer: "Yes, it is generally safe. However, we recommend it for children above 3 years old. We can also arrange a smoother ride for families with small children."
  },
  {
  ...
  },
  {
    ...
    answer: "Absolutely! Our BBQ dinner buffet includes a wide variety of vegetarian and vegan options, including salads, grilled vegetables, and traditional dishes."
  }
];
...
const FAQItem = ({ question, answer, isOpen, onToggle }) => {
  ...
  return (
    <div className="border-b border-gray-100 last:border-0">
      ...
      >
        <span className={`text-base font-bold transition-colors duration-200 ${isOpen ? 'text-blue-600' : 'text-gray-900 group-hover:text-blue-600'}`}>
          {question}
        </span>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:gap-x-16 xl:gap-x-24">
          ...
          <div className="flex flex-col justify-center">
            <h2 className="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">Common Questions</h2>
            <p className="mt-4 text-lg text-gray-500">Everything you need to know before booking.</p>
          ...
          <div className="lg:mt-0">
            ...
            <div className="relative rounded-2xl bg-gradient-to-r from-blue-600 via-purple-600 to-pink-500 p-[2px] shadow-2xl">
               <div className="relative h-full flex flex-col justify-between rounded-[14px] bg-white px-6 py-8 sm:p-10">
                 ...
                 <div>
                   ...
                   <div className="flex items-start justify-between">
                     <div>
                       <h3 className="text-xl font-bold text-gray-900">Quick Callback</h3>
                       <p className="mt-1 text-sm text-gray-500">Leave your details, we'll call you right back.</p>
                     </div>
                 ...
                 <div className="mt-8 flex items-center justify-between border-t border-gray-100 pt-6">
                   <div className="flex items-center gap-2.5">
                     ...
                     <span className="text-[10px] font-bold uppercase tracking-wider text-gray-600">Fast Track Active</span>
                   </div>
