...
const DESTINATIONS = [
  ...
  "Fujairah", "Musandam", "Al Ain", "Ajman", "Umm Al Quwain"
];
        ...
        <div className="container mx-auto px-4 py-8 relative z-10">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 bg-white/10 rounded-xl flex items-center justify-center flex-shrink-0 backdrop-blur-sm border border-white/10 shadow-inner">
            ...
            <div className="lg:col-span-3 space-y-6">
              ...
              <a href="/" className="flex items-center gap-3 flex-shrink-0 group">
                ...
                <div className="w-11 h-11 bg-[#0F172A] rounded-2xl flex items-center justify-center shadow-lg border border-slate-800 group-hover:border-slate-700 transition-colors">
                  <Compass className="text-amber-500" size={22} strokeWidth={2.5} />
                </div>
                {/* Logo Text */}
              ...
              <p className="text-xs leading-relaxed text-slate-500 font-medium">
                Premium UAE tourism partner. Creating authentic, safe experiences since 2002.
              </p>

              {/* Social Icons */}
              <div className="flex gap-2">
                {[Instagram, Facebook, Youtube].map((Icon, idx) => (
                  <a key={idx} href="#" className="w-9 h-9 rounded-lg bg-[#0F172A] border border-slate-800 flex items-center justify-center hover:bg-[#1d4ed8] hover:border-[#1d4ed8] hover:text-white transition-all text-slate-500">
                    <Icon size={16} />
                  </a>
                ))}
              </div>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {isLoading ? (
                    // Skeleton
                    [1,2,3,4,5,6].map(i => (
                      <div key={i} className="h-7 w-20 bg-[#0F172A] rounded-md animate-pulse border border-slate-800" />
                    ))
                  ) : (
  ...
  {cat.name}
            ...
            <div className="lg:col-span-4 space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-3">
                <div className="bg-[#0F172A] border border-slate-800 rounded-lg p-3 flex items-center gap-3 hover:border-slate-700 transition-colors group cursor-pointer">
                   ...
                   <div>
                      ...
                      <div className="text-white font-bold text-xs">+971 50 190 2213</div>
                   </div>
                </div>
                ...
                <div className="bg-[#0F172A] border border-slate-800 rounded-lg p-3 flex items-center gap-3 hover:border-slate-700 transition-colors group cursor-pointer">
                   ...
                   <div>
                      <div className="text-[9px] font-bold text-slate-500 uppercase tracking-wider">Office</div>
                      <div className="text-white font-bold text-xs">+971 4 295 2213</div>
                   </div>
                </div>
              </div>
              ...
              <div className="space-y-3 pl-1">
                <a href="mailto:info@dubaitours.com" className="flex items-center gap-3 group text-xs hover:text-[#3b82f6] transition-colors">
                  <Mail size={14} className="text-slate-500 group-hover:text-[#3b82f6]" />
                  info@dubaitours.com
                </a>
                <div className="flex items-start gap-3 text-xs">
                  <MapPin size={14} className="text-slate-500 mt-0.5 flex-shrink-0" />
                  <span className="text-slate-400">Office 213, Port Saeed, Deira, Dubai, UAE</span>
                </div>
              </div>
              ...
              <div className="bg-[#0F172A] rounded-lg p-4 border border-slate-800 mt-2 relative overflow-hidden group">
                 ...
                 <div className="flex justify-between items-center mb-3 relative z-10">
                    <div className="flex items-center gap-2">
                       ...
                       <span className="text-white font-bold text-xs tracking-tight">Secure Checkout</span>
                    </div>
                    <div className="text-right">
                       <div className="text-[9px] text-slate-500 uppercase font-bold">Trusted By</div>
                       <div className="text-white font-bold text-[10px]">30k+ Guests</div>
                    </div>
                 </div>
                 
                 <div className="flex gap-1.5 relative z-10">
                    <div className="px-2 py-1 bg-white rounded text-[9px] font-black text-[#1a1f71] tracking-tighter">VISA</div>
                    <div className="px-2 py-1 bg-white rounded text-[9px] font-black text-[#EB001B] tracking-tighter">MC</div>
                    <div className="px-2 py-1 bg-white rounded text-[9px] font-black text-[#006fcf] tracking-tighter">AMEX</div>
                 </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 mt-12 pt-8 border-t border-slate-900/50">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6 text-[11px] text-slate-600 font-medium">
            <div>
              &copy; {new Date().getFullYear()} Dubai Tours. All rights reserved.
            </div>
            <div className="flex flex-wrap justify-center gap-6">
               {['About Us', 'Privacy Policy', 'Terms of Service', 'Cancellation Policy', 'Sitemap'].map(link => (
                 <a key={link} href="#" className="hover:text-slate-400 transition-colors">{link}</a>
               ))}
            </div>
          </div>
        </div>
